    ...
    <IonPage>
      <IonContent>
        <div style={{ background: '#000', minHeight: '100vh', padding: '32px 20px 140px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '40px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <div>
                ...
                <p style={{ color: '#444', fontSize: '10px', margin: 0, fontWeight: 700, textTransform: 'uppercase' }}>Sistema de Gest├úo</p>
              </div>
            </div>
            <button 
              onClick={() => {
          ...
          <h2 style={{ color: '#fff', fontSize: '32px', fontWeight: 900, margin: '0 0 4px', letterSpacing: '-1px' }}>Hist├│rico</h2>
          <p style={{ color: '#666', fontSize: '15px', fontWeight: 600, marginBottom: '32px' }}>Servi├ºos finalizados</p>
              ...
              >
                ...
                {expandedId === item.id && (
                  <div style={{ marginTop: '20px', paddingTop: '20px', borderTop: '1px dashed #2a2a2a' }}>
                    <p style={{ color: '#444', fontSize: '11px', fontWeight: 900, textTransform: 'uppercase', marginBottom: '12px' }}>Laudo T├®cnico / Observa├º├Áes</p>
          ...
          {/* TabBar Inferior Padronizada (HIST├ôRICO ATIVO) */}
          <div style={{ 
