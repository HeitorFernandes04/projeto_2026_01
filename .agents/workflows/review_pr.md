...
3. **Qualidade Mobile**: Se o Ionic foi tocado (seja o app `mobile` do funcionário ou o novo `mobile-cliente`), utilize `run_frontend_tests` e `run_frontend_linter` especificando as pastas corretas.
